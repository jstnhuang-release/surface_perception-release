## surface_perception (indigo) - 1.0.3-0

The packages in the `surface_perception` repository were released into the `indigo` distro by running `/usr/bin/bloom-release surface_perception --track indigo --rosdistro indigo` on `Fri, 20 Apr 2018 22:20:45 -0000`
